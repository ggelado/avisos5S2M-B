...
const SHUTTLES = [
  {
    line: "LZ-CIU",
    destination: "Ciudad Universitaria → Campus de Montegancedo (PROGRAMADO. SOLO DÍAS LECTIVOS)",
    times: ["10:30", "11:30", "12:30", "13:30", "14:30"]
  }
];
...
(() => {
  ...
  async function loadArrivals() {
    ...
    return [...busArrivals, ...shuttleArrivals]
